...
export default function AdsPage() {
  ...
  const handleVideoClick = (label: string) => {
    window.open(`https://youtube.com/results?search_query=eFPS+Master+${encodeURIComponent(label)}`, '_blank', 'noopener,noreferrer');
    toast.success(`Searching for ${label}...`);
  };
  const handleSubscribe = () => {
    window.open('https://youtube.com/@technicalmasterji', '_blank', 'noopener,noreferrer');
    toast.success('Opening YouTube channel...');
  };
  const handleHelpline = () => {
    window.location.href = 'tel:9638104447';
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.showcaseCard}>
        ...
        <div className={styles.videoGrid}>
          {VIDEOS.map((video) => (
            <div
              ...
              onClick={() => handleVideoClick(video.label)}
            >
        ...
        <div className={styles.ctaRow}>
          ...
          <button className={styles.helplineBtn} onClick={handleHelpline}>
